...
export default function crear(){
    ...
    return(
        <main className="p-20 flex flex-col justify-center items-center mt-1 bg-[#f7f6f2] ">
            <h1 className="text-3xl font-bold mb-7">Nuevo empleado</h1>
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-2">
                    <label className="font-bold">Teléfono:  
                        <label className="font-light text-xs"> <span className="text-red-900">*</span>Ingrese 10 dígitos</label>
                    </label>
